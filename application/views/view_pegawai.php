...
echo $query->num_rows(); ?></h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">List Unit Mobil <a href="<?php echo base_url(); ?>pegawai/tambah_mobil" class="btn btn-success">Tambah Mobil</a>  <a href="<?php echo base_url(); ?>laporanpdf" class="btn btn-primary">LAPORAN PDF</a></h5>
		...
		foreach ($pegawais as $pegawai) {
			?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">List Transaksi <a href="<?php echo base_url(); ?>pegawai/tambah_penyewa" class="btn btn-success">Tambah Transaksi</a> 
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead class="bg-light">
